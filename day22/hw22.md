...
Just appends it, and doesn't care.

c. Does this algorithm produce an optimal result? (Do you have enough information to answer this question?)

Yes and no. It produces the fewest number of lines but there is potential that some words don't even wrap. It really depends on what is to be optimized.
